...
val versionNameOverride: String = (project.findProperty("versionName") as? String) ?: "0.3.5"
val versionCodeOverride: Int = (project.findProperty("versionCode") as? String)?.toIntOrNull() ?: 8
