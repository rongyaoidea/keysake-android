...
val versionNameOverride: String = (project.findProperty("versionName") as? String) ?: "0.3.3"
val versionCodeOverride: Int = (project.findProperty("versionCode") as? String)?.toIntOrNull() ?: 6
